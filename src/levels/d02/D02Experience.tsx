          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] px-2 py-0.5 bg-sky-500/10 text-sky-400 border border-sky-500/20 rounded-full font-mono">
              ...
              <button
                ...
                className="text-xs text-slate-400 hover:text-sky-300 flex items-center gap-1 bg-slate-800 px-2 py-1 rounded"
                title="重新朗读指导语"
              >
                <Volume2 size={13} />
                <span>朗读</span>
