...
export const A03_STAGE_CONTENT: Record<A03Step, A03StageContent> = {
  COLOR_CODE_CALC: {
    title: '实训步骤 1：四色环电阻识读与合格公差计算',
    objective: '识读 4 色环（红红棕金），计算标称阻值并推算 ±5% 允许公差区间',
    actions: [
      '观察色环：前两环为有效数字，第三环为乘数倍率，第四环为误差级别。',
      '计算标称值阻值及允许公差范围的下限与上限。',
      '在检测工单中填写公差下限与上限，点击“校验并提交区间”。',
    ],
    completion: '标称值与公差区间验证正确。',
    mentorPrompt:
      '徒弟，拿到色环电阻千万别直接拿表乱戳。先按红红棕金解码出标称阻值，算出公差合格区间！',
    hint: '红=2，红=2，棕=10¹(×10)，标称阻值为 220Ω；金=±5%(±11Ω)。下限 220-11=209Ω，上限 220+11=231Ω。',
